...
use App\Http\Controllers\front\BannerController as FrontBannerController;
...
Route::get('get-banner',[FrontBannerController::class,'getAllBanners']);
...
Route::group(['middleware'=>['auth:sanctum','checkUserRole']],function(){
    ...
    Route::get('get-account-details',[AccountController::class,'getUserDetails']);
});
...
Route::group(['middleware'=> ['auth:sanctum','checkAdminRole']],function(){
    ...
    Route::post('save-banner',[BannerController::class,'saveBannerImage']);
});
