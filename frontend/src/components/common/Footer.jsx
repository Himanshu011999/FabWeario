        ...
        <div className="row mb-5">
          <div className="col-md-3 pb-4">
            ...
            <div className="pt-3 pe-5">
              Discover the latest trends in clothing and shoes — all in one
              place.
            </div>
          </div>
          <div className="col-md-3 pb-4">
          ...
          <div className="col-md-3 pb-4">
            ...
            <ul>
              <li>
                <a href="#">+91-95XXXXXXXX</a>
              </li>
              <li>
                <a href="#">info@example.com</a>
              </li>
              <li className="d-flex gap-3">
                <a href="#" aria-label="Facebook" className="ps-2">
                  <i className="fab fa-facebook-f"></i>
                </a>
                <a href="#" aria-label="Twitter" className="ps-2">
                  <i className="fab fa-twitter"></i>
                </a>
                <a href="#" aria-label="YouTube" className="ps-2">
                  <i className="fab fa-youtube"></i>
                </a>
                <a href="#" aria-label="Instagram" className="ps-2">
